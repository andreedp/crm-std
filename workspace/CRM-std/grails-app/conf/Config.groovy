...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'crm.std.core.SecAppUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'crm.std.core.SecAppUserSecAppRole'
grails.plugin.springsecurity.authority.className = 'crm.std.core.SecAppRole'
...
multiTenant {
    tenantClass = crm.std.core.SecAppTenant
}
